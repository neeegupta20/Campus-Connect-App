...
//           onPress={()=>{setSelectedZone(null), setShowBottomSlider(false)}}
//           >
//           {Zones.map((zone)=>(
//             <Marker
//               key={zone.id}
...
//         </TouchableOpacity>
//         <BottomSlider isOpen={showBottomSlider} zone={selectedZone} onClose={()=>{setSelectedZone(null)}}/>
//       </View>
