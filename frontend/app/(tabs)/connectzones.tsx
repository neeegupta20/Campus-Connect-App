...
import { View, Image, Text, StyleSheet, Linking, Dimensions, TouchableOpacity } from "react-native";
import MapView, { Marker } from "react-native-maps";
import { GestureHandlerRootView } from "react-native-gesture-handler";
import AntDesign from '@expo/vector-icons/AntDesign';
import FontAwesome from '@expo/vector-icons/FontAwesome';
import BottomSlider from "../bottomSlider";
import ConnectZone from "../ConnectZones";
...
const styles = StyleSheet.create({
  container: { flex: 1 },
  infoContainer: { height: "100%", position: "relative" },
  ...
  title: { fontSize: 24, fontWeight: "bold", marginTop: 60, marginHorizontal: 10, color: "#333" },
  description: { fontSize: 16, margin: 10, color: "#555" },
  text: {
    color: "blue",
    fontSize: 20,
    marginTop: "10%",
