...
export default function otpVerify(){
        ...
        const VerifyOTP=async()=>{
            ...
            try{
                const response1=await axios.post('http://172.16.38.223:3000/verify-otp',{email,OTP:otpString});
                if(response1.status===200){
                    try{
                        const dataUser={name,email,password,telno,avatar};
                        const response2=await axios.post('http://172.16.38.223:3000/register',dataUser);
